"""Bond-order heuristics used by EDM molecule stability evaluation."""
...
def geom_predictor(atom_pair, distance, limit_bonds_to_one=False):
    bond_order = get_bond_order(atom_pair[0], atom_pair[1], distance, check_exists=True)
