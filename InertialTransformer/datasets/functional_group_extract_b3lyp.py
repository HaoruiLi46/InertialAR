...
from InertialTransformer.datasets.count_aromatic_heterocycles import count_aromatic_heterocycles_extended_v5, AROMATIC_HETEROCYCLES_EXTENDED_v5
...
def analyze_smiles_file(input_pt_file, output_npy_file, output_header_csv_file):
    ...
    name_list.extend(AROMATIC_HETEROCYCLES_EXTENDED_v5)
    ...
    for idx, smiles in tqdm(enumerate(smiles_list), total=len(smiles_list), desc="Analyzing SMILES"):
        ...
        if mol:
            ...
            s_num_from_aromantic_heterocycle) = count_aromatic_heterocycles_extended_v5(mol)
